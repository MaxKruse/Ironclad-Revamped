...
public class HandDamage extends DynamicVariable {   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    public int value(AbstractCard card) {
        return AbstractDungeon.player.hand.size() * card.damage;
    }
    ...
    public int baseValue(AbstractCard card) {
        return AbstractDungeon.player.hand.size() * card.baseDamage;
    }
