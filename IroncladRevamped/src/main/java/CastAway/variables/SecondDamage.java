...
public class SecondDamage extends DynamicVariable {   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    @Override
    public String key() {
        return makeID("SecondDamage".toUpperCase());
    }
