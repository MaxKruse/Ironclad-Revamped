package CastAway.variables;

import CastAway.cards.AbstractDefaultCard;
import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import com.megacrit.cardcrawl.ui.panels.EnergyPanel;

import static CastAway.DefaultMod.makeID;

public class DeckExhaust extends DynamicVariable {   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    public boolean isModified(AbstractCard card) {
        return  ((AbstractDefaultCard) card).isDeckExhaustModified;
    }
    ...
    public int value(AbstractCard card) {
        return  ((AbstractDefaultCard) card).deckExhaust;
    }
