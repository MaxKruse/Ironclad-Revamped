package CastAway.cards.Powers.common;

import CastAway.cards.AbstractDynamicCard;
import CastAway.powers.FeedbackPower;
...
public class InstantFeedback extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(InstantFeedback.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p,
                new FeedbackPower(p, p, magicNumber)));
