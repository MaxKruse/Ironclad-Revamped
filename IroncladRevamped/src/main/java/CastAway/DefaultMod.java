...
public class DefaultMod implements
    ...
    private static final String MODNAME = "The Cast Away";
    private static final String AUTHOR = "MaxKruse"; // And pretty soon - You!
    private static final String DESCRIPTION = "A strange man, obsessed with gathering and hoarding, but not too shy to throw away what he does not need.";
    
    // =============== INPUT TEXTURE LOCATION =================
    
    // Colors (RGB)
    // Character Color
    public static final Color DEFAULT_GRAY = CardHelper.getColor(107.f, 255.0f, 216.0f);
    ...
    private static final String ATTACK_DEFAULT_GRAY = "CastAwayResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "CastAwayResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "CastAwayResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "CastAwayResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "CastAwayResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "CastAwayResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "CastAwayResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "CastAwayResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "CastAwayResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "CastAwayResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "CastAwayResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "CastAwayResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "CastAwayResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "CastAwayResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "CastAwayResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "CastAwayResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "CastAwayResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        logger.info("Creating the color " + TheCastAway.Enums.COLOR_GRAY.toString());
        
        BaseMod.addColor(TheCastAway.Enums.COLOR_GRAY, DEFAULT_GRAY, DEFAULT_GRAY, DEFAULT_GRAY,
    ...
    public static void initialize() {
        logger.info("========================= Initializing CastAway Mod. =========================");
    ...
    public void receiveEditCharacters() {
        logger.info("Beginning to edit characters. " + "Add " + TheCastAway.Enums.THE_CAST_AWAY.toString());
        
        BaseMod.addCharacter(new TheCastAway("The Cast Away", TheCastAway.Enums.THE_CAST_AWAY),
                THE_DEFAULT_BUTTON, THE_DEFAULT_PORTRAIT, TheCastAway.Enums.THE_CAST_AWAY);
        
        receiveEditPotions();
        logger.info("Added " + TheCastAway.Enums.THE_CAST_AWAY.toString());
    }
    ...
    public void receivePostInitialize() {
        ...
        AddEventParams eventParams = new AddEventParams.Builder(IdentityCrisisEvent.ID, IdentityCrisisEvent.class) // for this specific event
            ...
            .playerClass(TheCastAway.Enums.THE_CAST_AWAY) // Character specific event
            .create();
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(PlaceholderPotion.class, PLACEHOLDER_POTION_LIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, PlaceholderPotion.POTION_ID, TheCastAway.Enums.THE_CAST_AWAY);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("CastAway") // ${project.artifactId}
